...
export const menuItem = [
    ...
    { menuIcon:'fas fa-chart-bar', menuString: 'Page1', children:[
        ...
        { menuIcon:'fas fa-child', menuString: 'Child2', children:[
            ...
            { menuIcon:'fas fa-child', menuString: 'Sub Common', link: 'page1/child2/subpage-common' }
        ] },
    ]  },
    { menuIcon:'fas fa-chart-bar', menuString: 'Page2', link: 'page2' },
    { menuIcon:'fas fa-chart-bar', menuString: 'Page3', children:[
        { menuIcon:'fas fa-child', menuString: 'Sub Common', link: 'page3/subpage-common' }
    ] }
]
